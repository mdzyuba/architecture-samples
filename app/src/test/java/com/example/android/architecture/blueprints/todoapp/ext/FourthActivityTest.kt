...
class FourthActivityTest {
    ...
    @Test
    fun testView() {
        val scenario = ActivityScenario.launch(FourthActivity::class.java)
        Espresso.onView(ViewMatchers.withId(R.id.textView)).check(ViewAssertions.matches(ViewMatchers.withText(R.string.fourth_activity)))
